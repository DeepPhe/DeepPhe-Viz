...
export default function createCancerAndTumorSummary(patientId) {
    ...
    const factsToIgnore = ["HER2/Neu Status", "Progesterone Receptor Status", "Estrogen Receptor Status","Course", "Lymph Involvement", "Treatments", "Behavior", "Tissue", "Quadrant", "Topography, minor", "Topography, major", "Test Results", "Procedures", "T Stage", "N Stage", "M Stage"]
