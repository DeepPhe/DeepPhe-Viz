...
//
//         showDerivedChart(targetPatients, allStagesLabel, currentFirstEncounterAgeRange);
//     }
//
//
//     // Render all stage bars and boxplots
...
//         html += '<li><a id="' + patient.patientId + '" class="target_patient" href="' + baseGuiUri + '/patient/' + patient.patientId + '" target="_blank">' + patient.patientId + '</a> (' + patient.firstEncounterAge + ')</li>';
//     });
//
//     html += '</ul>';
//
...
//         .attr("transform", "translate(" + 0 + "," + chartTopMargin + ")");
//
